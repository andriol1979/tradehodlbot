...
* The following dependencies are not known to work with Spring Native: 'Datadog, Spring Boot DevTools, Spring Configuration Processor, Flyway Migration'. As a result, your application may not work as expected.
...
```
$ docker run --rm tradehodlbot:0.0.1-SNAPSHOT
```
